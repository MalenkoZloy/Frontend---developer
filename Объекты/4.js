...
// решение 1
// let newProducts = products.filter(element => element.photos && element.photos?.length > 0)

// решение 2
let newProducts = products.filter(element => element.photos?.length > 0)

// console.log(newProducts);

products.sort((element1, element2) => element1.price - element2.price)
